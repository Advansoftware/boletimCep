					...
					echo "<tbody>";
						for($i = 0; $i < count($disciplinas); $i++)
						{
							echo "<tr>";
								...
								echo "<td>";
									echo "<a href='".$url."boletim/nota_disciplina/".$turma_id."/".$disciplinas[$i]['disciplina_id']."' title='Editar' style='color: #dc3545; cursor: pointer;' class='glyphicon glyphicon-edit'></a>";
								echo "</td>";
							echo "</tr>";
						}
					echo "</tbody>";
