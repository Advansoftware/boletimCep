		...
		<div class='col-lg-8 offset-lg-2'>
			<div class="card">
				...
				<h4 class="card-title" style="margin: 10px;">
					<?php echo "Selecione as disciplinas para a turma ".$Turma[0]['nome_turma'];  ?>
				</h4>
				<div class="card-body">
					<?php
			...
			<div class='row' style="margin: 10px;">
				<div class='col-lg-6'>
					<a class='btn btn-danger btn-block' href="<?php echo $url; ?>turma/create_edit/<?php echo $Turma[0]['id']."/1";  ?>" ><span class='glyphicon glyphicon-menu-left'></span> Voltar</a>
				</div>
				<div class='col-lg-6'>
